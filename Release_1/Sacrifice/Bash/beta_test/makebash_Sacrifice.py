...
SCRIPT_PATH = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/'
SCRIPT_NAME = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/beta_test.py' 
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/beta_test/out_{}.root'.format(i)
