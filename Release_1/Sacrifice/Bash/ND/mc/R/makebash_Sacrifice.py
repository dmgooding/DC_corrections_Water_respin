...
SCRIPT_NAME = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/ND/mc/AllSac_R_mc.py' 
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/outroots/ND/mc/R/out_{}.root'.format(i)
