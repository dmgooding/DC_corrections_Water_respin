...
runs = 760
BATCH_NAME = 'ND'
JOB_NAME = 'ND_data_sac_UR'
DATA_PATH = '/nfs/disk0/dgooding2/new_BatchSubmission_Subtupler/OldSubs_oldEcorr/N16_MC_int_subs/'
SCRIPT_PATH = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/ND/mc/'
SCRIPT_NAME = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/ND/mc/AllSac_udotr_mc.py' 
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/outroots/ND/mc/udotr/out_{}.root'.format(i)
